export default function PageHero({ title, subtitle, children }) {
  return (
    <section className="bg-background border-b border-border py-12 md:py-16" aria-labelledby="page-hero-title">
      <div className="container-custom">
        ...
        {subtitle && <p className="text-foreground/80 text-sm md:text-base mt-4 max-w-2xl leading-relaxed">{subtitle}</p>}
      </div>
    </section>
  );
}
